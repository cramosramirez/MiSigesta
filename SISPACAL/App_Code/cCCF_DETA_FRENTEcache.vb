...
Public Class cCCF_DETA_FRENTEcache
    Private _SESION As HttpSessionState


    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)>
    Public Function ObtenerLista(ByVal nombreSesion_ucListaCCF_DETA_FRENTE As String) As listaCCF_DETA_FRENTE
        Try
            Dim lista As listaCCF_DETA_FRENTE
            _SESION = HttpContext.Current.Session
            If _SESION(nombreSesion_ucListaCCF_DETA_FRENTE) Is Nothing Then Return New listaCCF_DETA_FRENTE
            lista = TryCast(_SESION(nombreSesion_ucListaCCF_DETA_FRENTE), listaCCF_DETA_FRENTE)
    ...
    Public Function Actualizar(ByVal ID_CCF_DETA As Int32, ByVal ID_CCF_ENCA As Int32,
        ...
        Try
            _SESION = HttpContext.Current.Session
            Dim mDetalle As listaCCF_DETA_FRENTE = _SESION(REFERENCIA)
