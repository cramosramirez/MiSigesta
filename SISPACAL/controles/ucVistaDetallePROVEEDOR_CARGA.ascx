...
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="3" width="100%" border="0">
	...
	<TR runat="server" id="trCODIGO_PLANILLA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="Label5" runat="server">Codigo en planilla:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtCODIGO" runat="server" Width="300px" MaxLength="10"></asp:TextBox><asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="txtNOMBRE_PROVEEDOR_CARGA" ErrorMessage="Nombre proveedor carga es Requerido"></asp:RequiredFieldValidator>
</TD>
		<TD width="10"></TD>
	</TR>
	...
	<TR runat="server" id="trNIT">
		...
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtNIT" runat="server" Width="300px" MaxLength="14"></asp:TextBox>
</TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trDUI">
		...
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtDUI" runat="server" Width="300px" MaxLength="9"></asp:TextBox>
</TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trCREDITO_FISCAL">
		...
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtCREDITO_FISCAL" runat="server" Width="300px" MaxLength="20"></asp:TextBox>
</TD>
		<TD width="10"></TD>
	</TR>
	...
	<TR runat="server" id="trDIRECCION">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="Label1" runat="server">Dirección:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtDIRECCION" runat="server" Width="300px" MaxLength="300"></asp:TextBox>
</TD>
		<TD width="10"></TD>
	</TR>
	...
	<TR runat="server" id="trTELEFONO">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="Label2" runat="server">Telefono:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtTELEFONO" runat="server" Width="300px" MaxLength="300"></asp:TextBox>
</TD>
		<TD width="10"></TD>
	</TR>

	<TR runat="server" id="trACTIVIDAD">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="Label3" runat="server">Actividad:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtACTIVIDAD" runat="server" Width="300px" MaxLength="300"></asp:TextBox>
</TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trCORREO">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="Label4" runat="server">Correo:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtCORREO" runat="server" Width="300px" MaxLength="300"></asp:TextBox>
</TD>
		<TD width="10"></TD>
	</TR>
