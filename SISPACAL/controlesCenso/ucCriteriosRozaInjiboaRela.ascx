...
<table border="0" >
    ...
    <tr id="trFRENTE_ROZA_PARTICULAR" runat="server" visible="false">
        <td><dx:ASPxLabel ID="ASPxLabel12" runat="server" Text="FRENTES DE ROZA:">
            </dx:ASPxLabel>
        </td>
        <th colspan="2">
            <dx:ASPxComboBox ID="cbxFRENTE_ROZA_PARTICULAR" ValueType="System.Int32" runat="server" DropDownStyle="DropDownList" 
                Theme="Office2010Blue" Width="220px" >                
            </dx:ASPxComboBox>           
        </th>
    </tr>
