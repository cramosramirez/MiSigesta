...
<dx:ASPxGridView ID="dxgvLista" runat="server" AutoGenerateColumns="False" DataSourceID="odsCriterios" KeyFieldName="CODICONTRATO" Width="100%" >    
                      ...
                      CustomButtonClick="function(s,e){                                                  
                            switch(e.buttonID){
                                case 'btnVistaPrevia':                                                                                                     
                                    ...
                                    break; 
                                case 'btnCartaAutoriza':                                                                                                     
                                    MostrarCartaAutorizacionServicios(s.GetRowKey(e.visibleIndex));
                                    break; 
                                case 'btnEliminar':   
                                    var aceptar;  
    ...
    <Columns>           
        ...
        <dx:GridViewCommandColumn VisibleIndex="2" AllowDragDrop="False" Visible="false" Caption="Ver Carta Auto." Name="colCartaAutoriza" ButtonType="Image" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="True" Width="50px"   >
            <CustomButtons>
                    <dx:GridViewCommandColumnCustomButton ID="btnCartaAutoriza" Image-IconID="print_preview_16x16" Image-ToolTip="Carta de autorización">                                             
                    </dx:GridViewCommandColumnCustomButton>                                        
            </CustomButtons>
        </dx:GridViewCommandColumn> 
        ...
        <dx:GridViewDataTextColumn VisibleIndex="2" Name="colVistaGenerarContratoLegal" Caption="Generar contrato Legal" HeaderStyle-Wrap="True" Width="40px" CellStyle-HorizontalAlign="Center" >
            <DataItemTemplate>
                <asp:ImageButton ID="lbtnGenerarContratoLegal" runat="server" AlternateText="Generar contrato Legal" ToolTip="Genera contrato legal" CommandName="GenerarContratoLegal" ImageUrl="~/imagenes/ContratoLegal.png"  CommandArgument='<%# Bind("CODICONTRATO")%>'></asp:ImageButton>                               
            </DataItemTemplate>
            <CellStyle HorizontalAlign="Center"></CellStyle>
        </dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataTextColumn FieldName="TOTALMZ_CONTRATOCB" Visible="false" VisibleIndex="13" Caption="Total ha contratocb" />
        ...
        <dx:GridViewDataTextColumn FieldName="APELLIDOS" VisibleIndex="25" Caption="Apellidos" Width="200px"  />
        <dx:GridViewDataTextColumn FieldName="NOMBRES" VisibleIndex="26" Caption="Nombres" Width="200px" />
