...
Partial Class controles_ucListaCONTRATO
    ...
    Public Event GenerarContratoLegal(ByVal CODICONTRATO As String)
...
#Region "Propiedades"
    ...
    Public Property PermitirCartaAutoriza() As Boolean
        Get
            Return Me.dxgvLista.Columns("colCartaAutoriza").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("colCartaAutoriza").Visible = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_RowCommand(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewRowCommandEventArgs) Handles dxgvLista.RowCommand
        ...
        If e.CommandArgs.CommandName = "EliminarContratoParaEsticana" Then
            ...
            End If
        End If
        If e.CommandArgs.CommandName = "GenerarContratoLegal" Then
            RaiseEvent GenerarContratoLegal(e.KeyValue)
        End If
    End Sub
