...
<dx:ASPxGridView ID="dxgvLista" runat="server" AutoGenerateColumns="False" Width="100%"  
    ...
    <Columns>
        ...
        <dx:GridViewDataSpinEditColumn FieldName="AREA" VisibleIndex="7" Caption="ha" >
            <Settings AllowAutoFilter = "False" />
            <PropertiesSpinEdit MinValue="0" ></PropertiesSpinEdit>  
        </dx:GridViewDataSpinEditColumn>
        <dx:GridViewDataSpinEditColumn FieldName="AREA_CANA" VisibleIndex="7" Caption="(ha) Caña" Width="110px"  >
            <Settings AllowAutoFilter = "False" />
            <PropertiesSpinEdit MinValue="0" ></PropertiesSpinEdit>  
        </dx:GridViewDataSpinEditColumn>        
        <dx:GridViewDataSpinEditColumn FieldName="TONELADAS" VisibleIndex="8" Caption="TCH" >     
            <Settings AllowAutoFilter = "False" />   
            <PropertiesSpinEdit MinValue="0" ></PropertiesSpinEdit>
        </dx:GridViewDataSpinEditColumn>
        <dx:GridViewDataTextColumn FieldName="TONEL_TC" EditFormSettings-Visible="False" VisibleIndex="9" Caption="(t) Ton.Métrica" >
            <Settings AllowAutoFilter = "False" />
            <EditItemTemplate>
        ...
        <dx:GridViewDataTextColumn FieldName="MZ_CENSO" Visible="false" VisibleIndex="10" UnboundType="Decimal" Caption="(h) Esticaña" >
            <PropertiesTextEdit DisplayFormatString="#,##0.00" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="TONEL_MZ_CENSO" Visible="false" VisibleIndex="10" UnboundType="Decimal" Caption="TCH Esticaña" />
        <dx:GridViewDataTextColumn FieldName="TONEL_CENSO" Visible="false" VisibleIndex="10" UnboundType="Decimal" Caption="(t) Esticaña" />      
