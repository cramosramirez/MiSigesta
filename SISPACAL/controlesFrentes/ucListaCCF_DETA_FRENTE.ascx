<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaCCF_DETA_FRENTE.ascx.vb" Inherits="controlesFrentes_ucListaCCF_DETA_FRENTE" %>
...
<script type="text/javascript">
    ...
    function OnEndCallbackGrid(s, e) {
        cpMantCCF_ENCA_FRENTE.PerformCallback('');
    }
</script>
...
<asp:ObjectDataSource ID="odsCCF_DETA_FRENTEcache" runat="server" TypeName="cCCF_DETA_FRENTEcache"     
    SelectMethod="ObtenerLista" 
    UpdateMethod="Actualizar" DeleteMethod="Eliminar">       
     <SelectParameters>             
        <asp:Parameter Name="nombreSesion_ucListaCCF_DETA_FRENTE" Type="String" />
     </SelectParameters>     
     <UpdateParameters>    
