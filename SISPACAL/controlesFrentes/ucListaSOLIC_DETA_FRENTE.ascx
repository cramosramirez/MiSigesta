<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaSOLIC_DETA_FRENTE.ascx.vb" Inherits="controlesFrentes_ucListaSOLIC_DETA_FRENTE" %>
...
<script type="text/javascript">
    ...
    function OnEndCallbackGrid(s, e) {       
        cpVistaDetalleSOLIC_DETA_FRENTE.PerformCallback('');
    }
</script>
<dx:ASPxGridView ID="dxgvLista" runat="server" AutoGenerateColumns="False" Width="100%"  KeyFieldName="ID_SOLIC_DETA">
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="ID_SOLIC_DETA" ReadOnly="True" VisibleIndex="2" Caption="Id solic frente" Visible="false" />
        ...
        <dx:GridViewDataTextColumn VisibleIndex="10" Name="Eliminar" Caption=" " Width="20px"  CellStyle-HorizontalAlign="Center" >
            <DataItemTemplate>
                <asp:ImageButton ID="lbtnEliminar" runat="server" AlternateText="Eliminar" ToolTip="Eliminar" CommandName="Eliminar" ImageUrl="~/imagenes/eliminar.png"  CommandArgument='<%# Bind("ID_SOLIC_DETA")%>'></asp:ImageButton>                             
            </DataItemTemplate>
...
<asp:ObjectDataSource ID="odsSolicProdFrenteCache" runat="server" TypeName="cSOLIC_DETA_FRENTEcache" 
    SelectMethod="ObtenerLista" UpdateMethod="Actualizar" DeleteMethod="Eliminar" >       
     <SelectParameters>       
        <asp:Parameter Name="nombreSesion_uclistaSOLIC_DETA_FRENTE" Type="String" />
     </SelectParameters>    
     <UpdateParameters>    
        <asp:Parameter Name="ID_SOLIC_DETA" Type="Int32" />           
...
<asp:ObjectDataSource ID="odsLista" runat="server" 
    SelectMethod="ObtenerLista" InsertMethod="AgregarSOLIC_DETA_FRENTE" DeleteMethod="EliminarSOLIC_DETA_FRENTE" UpdateMethod="ActualizarSOLIC_DETA_FRENTE"
    TypeName="SISPACAL.BL.cSOLIC_DETA_FRENTE">
    <SelectParameters>
    ...
    <InsertParameters>
        <asp:Parameter DefaultValue="0" Name="ID_SOLIC_DETA" Type="Int32" />
        <asp:Parameter Name="ID_SOLICITUD" Type="Int32" />
        <asp:Parameter Name="ID_PRODUCTO" Type="Int32" />
        <asp:Parameter Name="NOMBRE_PRODUCTO" Type="String" />
        <asp:Parameter Name="PRESENTACION" Type="String" />
...
<asp:ObjectDataSource ID="odsListaPorSOLIC_ENCA_FRENTE" runat="server" 
    SelectMethod="ObtenerListaPorSOLIC_ENCA_FRENTE" InsertMethod="AgregarSOLIC_PROD_TRANS" DeleteMethod="EliminarSOLIC_PROD_TRANS" UpdateMethod="ActualizarSOLIC_PROD_TRANS"
...
<asp:ObjectDataSource ID="odsListaPorPRODUCTO" runat="server" 
    SelectMethod="ObtenerListaPorPRODUCTO" InsertMethod="AgregarSOLIC_DETA_FRENTE" DeleteMethod="EliminarSOLIC_DETA_FRENTE" UpdateMethod="ActualizarSOLIC_DETA_FRENTE"
    TypeName="SISPACAL.BL.cSOLIC_DETA_FRENTE">
    <SelectParameters>
        <asp:Parameter Name="ID_PRODUCTO" Type="Int32" />        
        <asp:Parameter DefaultValue="" Name="asColumnaOrden" Type="String" />
