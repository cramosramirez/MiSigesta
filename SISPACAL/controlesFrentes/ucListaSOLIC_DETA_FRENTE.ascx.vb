Imports SISPACAL.BL
Imports SISPACAL.EL
Partial Class controlesFrentes_ucListaSOLIC_DETA_FRENTE
    Inherits ucListaBase

    Private mComponente As New cSOLIC_DETA_FRENTE
    Public Event Seleccionado(ByVal ID_SOLIC_DETA As Int32)
    Public Event Editando(ByVal ID_SOLIC_DETA As Int32)
    Public Event Eliminando(ByVal ID_SOLIC_DETA As Int32)
...
#Region "Propiedades"
    ...
    Public Property VerID_SOLIC_DETA_FRENTE() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_SOLIC_DETA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_SOLIC_DETA").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_SOLIC_DETA_FRENTE() As String
        Get
            Return Me.dxgvLista.Columns("ID_SOLIC_DETA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_SOLIC_DETA").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Public Function CargarDatosCache(ByVal nombreSesion As String) As Integer
        ...
        Me.odsSolicProdFrenteCache.SelectParameters("nombreSesion_uclistaSOLIC_DETA_FRENTE").DefaultValue = nombreSesion
        Me.odsSolicProdFrenteCache.DataBind()
        Me.dxgvLista.DataSourceID = "odsSolicProdFrenteCache"
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla SOLIC_DETA_FRENTE
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorSOLIC_ENCA_FRENTE(ByVal ID_SOLICITUD As Int32) As Integer
        Me.odsListaPorSOLIC_ENCA_FRENTE.SelectParameters("ID_SOLICITUD").DefaultValue = ID_SOLICITUD.ToString()
        Me.odsListaPorSOLIC_ENCA_FRENTE.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorSOLIC_ENCA_FRENTE.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorSOLIC_ENCA_FRENTE.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorSOLIC_ENCA_FRENTE"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_SOLIC_DETA")
    ...
    Protected Sub dxgvLista_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles dxgvLista.Init
        ...
        End If
        dxgvLista.ForceDataRowType(GetType(listaSOLIC_DETA_FRENTE))
    End Sub
    ...
    Protected Sub dxgvLista_RowCommand(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewRowCommandEventArgs) Handles dxgvLista.RowCommand
        ...
        If e.CommandArgs.CommandName = "Eliminar" Then
            Dim b As New cSOLIC_DETA_FRENTEcache
    ...
    Public Function DevolverSeleccionados() As listaSOLIC_DETA_FRENTE
        Dim mLista As New listaSOLIC_DETA_FRENTE
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_SOLIC_DETA")
            Dim lEntidad As New SOLIC_DETA_FRENTE
            lEntidad.ID_SOLIC_DETA = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As SOLIC_DETA_FRENTE = CType(Me.dxgvLista.GetRow(e.VisibleIndex), SOLIC_DETA_FRENTE)

            If Me.mComponente.EliminarSOLIC_DETA_FRENTE(lEntidad.ID_SOLIC_DETA) <> 1 Then
    ...
    Private Function ObtenerSubTotal() As Decimal
        ...
        If Session(Me.REFERENCIA) IsNot Nothing Then
            For Each lProducto As SOLIC_DETA_FRENTE In DirectCast(Session(Me.REFERENCIA), listaSOLIC_DETA_FRENTE)
