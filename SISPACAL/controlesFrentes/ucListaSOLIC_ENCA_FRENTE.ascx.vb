Imports SISPACAL.BL
Imports SISPACAL.EL
Partial Class controlesFrentes_ucListaSOLIC_ENCA_FRENTE
...
#Region "Propiedades"
    ...
    Public Property VerUID_SOLIC_ENCA_FRENTE() As Boolean
        Get
            Return Me.dxgvLista.Columns("UID_SOLIC_ENCA_FRENTE").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("UID_SOLIC_ENCA_FRENTE").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderUID_SOLIC_ENCA_FRENTE() As String
        Get
            Return Me.dxgvLista.Columns("UID_SOLIC_ENCA_FRENTE").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("UID_SOLIC_ENCA_FRENTE").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla SOLIC_ENCA_FRENTE
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Public Function DevolverSeleccionados() As listaSOLIC_ENCA_FRENTE
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As SOLIC_ENCA_FRENTE = CType(Me.dxgvLista.GetRow(e.VisibleIndex), SOLIC_ENCA_FRENTE)

            lEntidad = (New cSOLIC_ENCA_FRENTE).ObtenerSOLIC_ENCA_FRENTE(lEntidad.ID_SOLICITUD)
            If lEntidad.ID_ESTADO_SOLIC <> Enumeradores.EstadoSolicAgricola.Pendiente Then
                ...
                Return
            End If
            If Me.mComponente.EliminarSOLIC_ENCA_FRENTE(lEntidad.ID_SOLICITUD) <> 1 Then
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        If e.Column.FieldName = "DESCRIP_ESTADO_SOLIC" Then
