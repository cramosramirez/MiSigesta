...
Partial Class controlesFrentes_ucMantSOLIC_ENCA_FRENTE
    Inherits ucBase
...
#Region "Inicializaciones Mantenimiento"
    ...
    Public Sub InicializarLista()
        If Me.TIPO_PROVEEDOR = TipoProveedor.FrenteRoza Then
            Me.lblTitulo.Text = "Mantenimiento de Solicitudes de Insumo para Frentes de Roza"
        Else
            Me.lblTitulo.Text = "Mantenimiento de Solicitudes de Insumo para Frentes de Querqueo"
        End If
        ...
        Me.ucListaSOLIC_ENCA_FRENTE1.Visible = True
        Me.ucVistaDetalleSOLIC_ENCA_FRENTE1.Visible = False
    End Sub
    ...
    Private Sub InicializarDetalle(ByVal estado As Int32)
        If Me.TIPO_PROVEEDOR = TipoProveedor.FrenteRoza Then
            Me.lblTitulo.Text = "Consulta de Solicitud de Insumo para Frentes de Roza"
        Else
            Me.lblTitulo.Text = "Consulta de Solicitud de Insumo para Frentes de Querqueo"
        End If
        ...
        Me.ucBarraNavegacion1.VerOpcion("Guardar", estado = Enumeradores.EstadoSolicAgricola.Pendiente)
        Me.ucBarraNavegacion1.VerOpcion("Aceptar", estado = Enumeradores.EstadoSolicAgricola.Pendiente)
        Me.ucBarraNavegacion1.VerOpcion("Cancelar", True)
        Me.ucListaSOLIC_ENCA_FRENTE1.Visible = False
        Me.ucVistaDetalleSOLIC_ENCA_FRENTE1.TIPO_PROVEEDOR = Me.TIPO_PROVEEDOR
        Me.ucVistaDetalleSOLIC_ENCA_FRENTE1.Visible = True
    End Sub
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Try
            Return Me.CargarSOLIC_ENCA_FRENTE()
    ...
    Private Function CargarSOLIC_ENCA_FRENTE() As Integer
        If Me.ucListaSOLIC_ENCA_FRENTE1.CargarDatosPorTIPO_PROVEEDOR(Me.TIPO_PROVEEDOR) <> 1 Then Return -1
        Return 1
    End Function
    ...
    Private Sub ucBarraNavegacion1_Guardar(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucBarraNavegacion1.Guardar
        ...
        sError = Me.ucVistaDetalleSOLIC_ENCA_FRENTE1.Actualizar()
        If sError <> "" Then
            Return
        End If
        Me.InicializarLista()
    ...
    Protected Sub ucListaSOLIC_ENCA_TRANS1_Editando(ByVal ID_SOLICITUD As Int32) Handles ucListaSOLIC_ENCA_FRENTE1.Editando
        ...
        Me.ucVistaDetalleSOLIC_ENCA_FRENTE1.ID_SOLICITUD = ID_SOLICITUD
    End Sub
    ...
    Protected Sub ucBarraNavegacion1_OpcionSeleccionada(CommandName As String) Handles ucBarraNavegacion1.OpcionSeleccionada
        Select Case CommandName
            ...
            Case "Exportar"
                Me.ucListaSOLIC_ENCA_FRENTE1.ExportarExcel()

            Case "Agregar"
                Me.InicializarDetalle(-1)
                Me.ucVistaDetalleSOLIC_ENCA_FRENTE1.LimpiarControles()
                Me.ucVistaDetalleSOLIC_ENCA_FRENTE1.ID_SOLICITUD = 0
            ...
            Case "Guardar"
                ...
                Me.ucListaSOLIC_ENCA_FRENTE1.DataBind()
                Me.ucVistaDetalleSOLIC_ENCA_FRENTE1.LimpiarControles()
                Me.ucVistaDetalleSOLIC_ENCA_FRENTE1.ID_SOLICITUD = 0
                Return
            ...
            Case "Aceptar"
                Dim sError As String
                sError = Me.ucVistaDetalleSOLIC_ENCA_FRENTE1.Aceptar
                If sError <> "" Then
                    AsignarMensaje(sError, True, False)
                    Return
                End If
