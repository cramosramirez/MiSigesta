<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReporteFrente.ascx.vb" Inherits="controlesFrentes_ucReporteFrente" %>
<%@ Register Src="~/controles/ucBarraNavegacion.ascx" TagName="ucBarraNavegacion" TagPrefix="uc1" %>
<%@ Register Src="~/controlesFrentes/ucCriteriosFrentes.ascx" TagName="ucCriteriosFrentes" TagPrefix="uc1" %>
...
<table id="TableMant" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            <uc1:ucCriteriosFrentes ID="ucCriteriosFrentes1" runat="server"></uc1:ucCriteriosFrentes>
        </td>
    </tr>
   <tr>
        <td>
