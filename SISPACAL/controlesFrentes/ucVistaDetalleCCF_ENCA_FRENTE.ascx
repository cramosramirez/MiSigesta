<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleCCF_ENCA_FRENTE.ascx.vb" Inherits="controlesFrentes_ucVistaDetalleCCF_ENCA_FRENTE" %>
<%@ Register assembly="DevExpress.Web.v14.2, Version=14.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
<%@ Register tagprefix="uc1" tagname="ucListaCCF_DETA_FRENTE" Src="~/controlesFrentes/ucListaCCF_DETA_FRENTE.ascx" %>


<table width="100%" >
    <tr>
        <td align="center">
            <dx:ASPxFormLayout ID="ucVistaDetalleCCF_ENCA_FRENTELayout" ClientInstanceName="ucVistaDetalleCCF_ENCA_FRENTELayout" runat="server" Width="1000px">
                <Items>
                                    ...
                                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><dx:ASPxLabel id="ASPxLabel25" Visible="false"  runat="server" Text="N° Orden:" /></td>
                                                <td>
                                                    <dx:ASPxComboBox ID="cbxORDEN_COMPRA" Visible="false" runat="server" AutoPostBack="true" HorizontalAlign="Right" ValueField="ID_ORDEN" TextField="CODI_ORDEN" ValueType="System.Int32" Width="120px" DropDownStyle="DropDownList">                                                               
                                                    <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black" ></DisabledStyle>
                                                    </dx:ASPxComboBox>
                                                </td>
                                            </tr>       
                                            ...
                                            <tr>
                                                <td><dx:ASPxLabel id="ASPxLabel6" runat="server" Text="Código FRENTE:" /></td>
                                                <td>
                                                   <dx:ASPxTextBox id="txtCOD_FRENTE"  AutoPostBack="true" runat="server" Width="170px" >
                                                       <ValidationSettings Display="Dynamic" SetFocusOnError="True">
			                                                <RequiredField ErrorText="Campo Cod Frente es requerido" IsRequired="True" />
			                                            </ValidationSettings>
                                                        <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                                    </dx:ASPxTextBox>                                                    
                                                </td>
                                                <td><dx:ASPxLabel id="ASPxLabel7" runat="server" Text="Nombre FRENTE:" /></td>
                                                <th colspan="3" >
                                                    <dx:ASPxTextBox id="txtNOM_FRENTE" runat="server" Width="100%" >
                                                       <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                                    </dx:ASPxTextBox>
                                                </th>
                                            </tr>                               
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 <td><dx:ASPxLabel id="ASPxLabel27" runat="server" Text="Cuenta contable (p/cheques):" /></td>
                                                 <th colspan="3" >
                                                    <dx:ASPxTextBox ID="txtCTA_CONTABLE" runat="server" ClientInstanceName="txtCTA_CONTABLE" Width="100%" >    
                                                    <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>                                                           
                                                    </dx:ASPxTextBox>
                                                </th>
                                            </tr>
    ...
    <tr>
        <td align="center">
            <table>
                ...
                <tr>
                    <th colspan="6" >
                        <uc1:ucListaCCF_DETA_FRENTE id="ucListaCCF_DETA_FRENTE1" PermitirFiltroEnEncabezado="false" PermitirFilaDeFiltro="false" PermitirEditarInline="true" PermitirEliminarInline="true" PermitirEliminar="true"  runat="server"></uc1:ucListaCCF_DETA_FRENTE>                                    
                    </th>                                            
                </tr>
		        <tr>
...
<asp:ObjectDataSource ID="odsCuentaFinan" runat="server" 
    OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerListaParaSolicFrentes" 
