<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleSOLIC_ENCA_FRENTE.ascx.vb" Inherits="controlesFrentes_ucVistaDetalleSOLIC_ENCA_FRENTE" %>
<%@ Register assembly="DevExpress.Web.v14.2, Version=14.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>

<%@ Register tagprefix="uc1" tagname="ucListaSOLIC_DETA_FRENTE" Src="~/controlesFrentes/ucListaSOLIC_DETA_FRENTE.ascx" %>


<dx:ASPxCallbackPanel ID="cpVistaDetalleSOLIC_DETA_FRENTE" ClientInstanceName="cpVistaDetalleSOLIC_DETA_FRENTE" runat="server" ShowLoadingPanel="false" Width="100%" >    
...
<table width="1100px" >
    <tr>
        <td align="center">
        <dx:ASPxFormLayout ID="ucVistaDetalleSOLIC_ENCA_FRENTELayout" ClientInstanceName="ucVistaDetalleSOLIC_ENCA_FRENTELayout" runat="server" Width="900px">
                <Items>
                                ...
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server">
                                        <table>
                                            ...
                                            <tr>
                                                <td><dx:ASPxLabel ID="aspxlabel4" runat="server" Text="Código Frente:" /></td>
                                                <td>
                                                    <dx:ASPxTextBox ID="txtCOD_FRENTE" runat="server" AutoPostBack="true" Width="150px"  >
                                                ...
                                                <td><dx:ASPxLabel ID="aspxlabel5" runat="server" Text="Nombre Frente:" /></td>
                                                <td>
                                                    <dx:ASPxTextBox ID="txtNOMBRE_FRENTE" runat="server" Width="300px" BackColor="WhiteSmoke">                               
                                                    <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                                    </dx:ASPxTextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td><dx:ASPxLabel ID="aspxlabel6" runat="server" Text="Cuota a descontar por Corte:" /></td>
                                                <td>
                                                    <dx:ASPxSpinEdit ID="speCUOTA_X_CORTE" runat="server" DisplayFormatString="#,##0.00##" Width="150px"  SpinButtons-ShowIncrementButtons="false" HorizontalAlign="Right" >	
    ...
    <tr>
        <td>            
            <table>
                ...
                <tr>
                    <th colspan="7">
                        <uc1:ucListaSOLIC_DETA_FRENTE id="ucListaSOLIC_DETA_FRENTE1" PermitirFiltroEnEncabezado="false" PermitirFilaDeFiltro="false" PermitirEditarInline="true" PermitirEliminarInline="true" PermitirEliminar="true"  runat="server"></uc1:ucListaSOLIC_DETA_FRENTE>                                    
                    </th>
                </tr>
                <tr>
...
<dx:ASPxLabel ID="lblID_FRENTE" runat="server" Visible="false" />  
