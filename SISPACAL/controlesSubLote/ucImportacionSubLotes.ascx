<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucImportacionSubLotes.ascx.vb" Inherits="controlesSubLote_ucImportacionSubLotes" %>
            ...
            <table  border="0" width="80%" >                
                ...
                <tr>
                    <td style="text-align:center">
                        <dx:ASPxLabel ID="ASPxLabel10" runat="server" Font-Names="Arial" Font-Bold="true" Font-Size="Medium" Text="SUBIR EXCEL DE PORCIONES (SUBLOTES) AL SISTEMA" />
                    </td>
                </tr>
                <tr>
                    <td>      
