<Serializable(), Table(Name:="SOLIC_DETA_FRENTE")>
Public Class SOLIC_DETA_FRENTE
    Inherits entidadBase

    Public Sub New()
    End Sub

    Private _ID_SOLIC_DETA As Int32
    <Column(Name:="ID_SOLIC_DETA", Storage:="ID_SOLIC_DETA", DBType:="INT NOT NULL", Id:=True),
     DataObjectField(True, False, False), Precision(Precision:=10, Scale:=255)>
    Public Property ID_SOLIC_DETA() As Int32
        Get
            Return _ID_SOLIC_DETA
        End Get
        Set(ByVal Value As Int32)
            _ID_SOLIC_DETA = Value
            OnPropertyChanged("ID_SOLIC_DETA")
        End Set
    End Property
    ...
    <Column(Name:="NOMBRE_PRODUCTO", Storage:="NOMBRE_PRODUCTO", DBType:="VARCHAR(100) NULL", Id:=False),
    ...
    <Column(Name:="SUB_TOTAL", Storage:="SUB_TOTAL", DBType:="NUMERIC(10,4) NULL", Id:=False),
     DataObjectField(False, False, False), Precision(Precision:=10, Scale:=4)>
