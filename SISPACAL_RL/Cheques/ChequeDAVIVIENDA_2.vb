...
Public Class ChequeDAVIVIENDA_2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISPACAL.RL.ChequeDAVIVIENDA_2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChequeDAVIVIENDA_2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChequeDAVIVIENDA_2 = New ChequeDAVIVIENDA_2()
        rpt.Site = Me.Site
        Return rpt
    End Function
