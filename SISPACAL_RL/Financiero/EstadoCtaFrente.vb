...
Public Class EstadoCtaFrente
    Public Sub CargarDatos(ByVal ID_ZAFRA As Integer, ByVal ID_TIPO_PROVEEDOR As Integer, ByVal ID_FRENTE As Integer, ByVal ID_CUENTA_FINAN As Integer)
        DS_TRANSPORTE1.Clear()
        REPO_ESTADO_CTAFRENTETableAdapter1.FillPorCriterios(DS_TRANSPORTE1.REPO_ESTADO_CTAFRENTE, ID_ZAFRA, ID_TIPO_PROVEEDOR, ID_FRENTE, ID_CUENTA_FINAN)

        If ID_TIPO_PROVEEDOR = Enumeradores.TipoProveedor.FrenteRoza Then
            Me.xrTitulo.Text = "ESTADO DE CUENTA DE FRENTES DE ROZA"
        ElseIf ID_TIPO_PROVEEDOR = Enumeradores.TipoProveedor.FrenteRoza Then
            Me.xrTitulo.Text = "ESTADO DE CUENTA DE FRENTES DE QUERQUEO"
        End If
