...
Public Class EstadoCtaProveedorAgricolaProductor
    Dim mES_DETALLE As Integer
    Public Sub CargarDatos(ByVal ID_ZAFRA As Integer, ByVal ID_CUENTA_FINAN As Integer, ByVal ID_PROVEE As Integer, ByVal CODIBANCO As Integer, ByVal ES_DETALLE As Integer, ByVal ES_OCULTAR_SIN_SALDO As Integer)

        mES_DETALLE = ES_DETALLE
        DS_TRANSPORTE1.Clear()
        RepO_ESTADO_PROVEE_DE_PRODUCTORTableAdapter1.FillPorCriterios(DS_TRANSPORTE1.REPO_ESTADO_PROVEE_DE_PRODUCTOR, ID_ZAFRA, ID_CUENTA_FINAN, ID_PROVEE, CODIBANCO, ES_DETALLE, ES_OCULTAR_SIN_SALDO)
    ...
    Private Sub EstadoCtaProveedorAgricolaProductor_BeforePrint(sender As Object, e As PrintEventArgs) Handles Me.BeforePrint
        If mES_DETALLE = 1 Then
            Detail.Visible = True
